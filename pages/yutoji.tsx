  ...
  return <>
    ...
    <div className={`cell`}>
      {Array.isArray(emote.shortcode)
        ? <ul className={`list`}>
          {emote.shortcode.map(code => <li><Shortcode>{code}</Shortcode></li>)}
        </ul>
...
export default function Yutoji(props: YutojiProps) {
  return <Layout>
    ...
    <section className={`grid`}>
      <div className={`col-head`}><h2 className={`${utilStyles.headingMd}`}>Image</h2></div>
      <div className={`col-head`}><h2 className={`${utilStyles.headingMd}`}>Shortcode</h2></div>
      <div className={`col-head`}><h2 className={`${utilStyles.headingMd}`}>Definition</h2></div>
