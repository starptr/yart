...
export const iconJsxMapping = {
	...
	spotify: (
		<span className={`${styles.icon} ${styles.spotify}`}>
			<GrSpotify />
		</span>
	),
	soundcloud: (
		<span className={`${styles.icon} ${styles.soundcloud}`}>
			<GrSoundcloud />
		</span>
	),
	douyin: (
		<span className={`${styles.icon} ${styles.douyin}`}>
			<SiTiktok />
		</span>
	),
	tiktok: (
		<span className={`${styles.icon} ${styles.tiktok}`}>
			<SiTiktok />
		</span>
	),
	meme: (
		<span className={`${styles.icon} ${styles.meme}`}>
			<Image alt="Meme icon" src={Meme} width="20" height="20" />
		</span>
	),
...
export function Year(props: YearProps) {
	return (
		<div className={`${utilStyles.centerH}`}>
			<h2 className={`${styles.text} ${utilStyles.headingXl} ${utilStyles.light}`}>
				{props.children}
			</h2>
		</div>
	);
...
export function Season(props: SeasonProps) {
	return (
		<div className={`${utilStyles.centerH}`}>
			<h2
				className={`${styles.seasonContainer} ${styles.text} ${utilStyles.headingMd} ${utilStyles.light}`}
			>
				{props.children}
...
export function Group(props: GroupProps) {
	return (
		<div className={`${utilStyles.centerH}`}>
			<p className={`${styles.text} ${utilStyles.headingMd} ${utilStyles.bold}`}>
				{props.children}
			</p>
		</div>
	);
...
export function List(props: ListProps) {
	return (
		<div>
			<ul className={`${styles.text} ${styles.list}`}>{props.children}</ul>
		</div>
	);
}
